...
export const getPublishedNews = () => {
  ...
  const defaultNews = [
    ...
    {
      id: "news3",
      title: "武嶺福利社上架即期麵包，買二送一，先搶先贏！",
      content: "校園超商推出新款即期麵包，買二送一優惠，數量有限，先搶先贏！優惠期間：5月10日至5月20日。",
      date: "2023-05-07",
      source: "系統公告",
      isPublished: true,
      createdAt: "2023-05-07T00:00:00.000Z",
      updatedAt: "2023-05-07T00:00:00.000Z",
      publishedAt: "2023-05-07T00:00:00.000Z"
    },
  ]

  // 如果在瀏覽器環境中，初始化 localStorage
  if (typeof window !== "undefined" && !localStorage.getItem("news")) {
