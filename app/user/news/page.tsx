...
async function loadCombinedNewsData(): Promise<NewsItemType[]> {
  ...
  // 3. 沒數據用預設
  if (allNews.length === 0) {
    const defaultNews: NewsItemType[] = [
      {
        id: "default_news1",
        title: "校園超商推出新款即期麵包，買二送一，先搶先贏！",
        content: "校園超商推出新款即期麵包，買二送一優惠，數量有限，先搶先贏！優惠期間：5月9日至5月15日。",
        date: "2023-05-09",
        source: "校園超商",
        isPublished: true,
        createdAt: "2023-05-09T00:00:00.000Z",
        updatedAt: "2023-05-09T00:00:00.000Z",
        images: ["/placeholder.jpg", "/images/nsysu-campus.png"]
      },
      {
        id: "default_news2",
      ...
      {
        id: "default_news3",
        title: "本週五起，惜食快go攜手校內五家商店推出即期品特賣活動",
        content: "本週五起，惜食快go攜手校內五家商店推出即期品特賣活動，多款商品低至五折，活動期間：5月12日至5月14日。",
        date: "2023-05-07",
        source: "系統公告",
        isPublished: true,
